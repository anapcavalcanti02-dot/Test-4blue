...
| **Passos para reproduzir** | 1. Acessar a tela de Login. 2. Deixar os campos Email e Senha em branco. 3. Clicar em "Entrar". |
...
| **Passos para reproduzir** | 1. Acessar a tela de Login. 2. Inserir o email de uma conta já criada. 3. Deixar o campo Senha em branco. 4. Clicar em "Entrar". |
...
| **Passos para reproduzir** | 1. Acessar a tela de Login. 2. Inserir o email de uma conta já criada. 3. Inserir uma senha incorreta no campo Senha. 4. Clicar em "Entrar". |
| **Resultado atual** | Alerta exibido: "Conta não encontrada. Crie uma conta primeiro." |
...
| **Passos para reproduzir** | 1. Acessar a tela de Login. 2. Inserir um email em formato inválido (ex: "teste", "teste@", "teste@email"). 3. Preencher ou não o campo Senha e clicar em "Entrar". |
...
| **Passos para reproduzir** | 1. Acessar a tela de Login. 2. Observar o conteúdo abaixo do campo Senha. |
...
| **Passos para reproduzir** | 1. Acessar a tela de Login. 2. Preencher os campos Email e Senha. 3. Pressionar a tecla Enter no teclado (sem clicar no botão). |
...
| **Passos para reproduzir** | 1. Acessar a tela "Criar conta". 2. Observar a disposição e a largura dos campos do formulário. |
...
| **Passos para reproduzir** | 1. Acessar a tela "Criar conta". 2. Não preencher nenhum campo. 3. Clicar em "Criar conta". |
...
| **Passos para reproduzir** | 1. Acessar a tela "Criar conta". 2. Clicar no campo Telefone e digitar letras ou texto. 3. Verificar que a entrada é aceita. |
...
| **Passos para reproduzir** | 1. Acessar a tela "Criar conta". 2. Preencher o campo Email com formato inválido (ex: "teste" ou "teste@"). 3. Preencher os demais campos e clicar em "Criar conta". |
...
| **Passos para reproduzir** | 1. Acessar a tela "Criar conta". 2. Inserir senha com menos de 8 caracteres ou sem caractere especial. 3. Inserir valor diferente em "Confirmar senha". 4. Preencher os demais campos e clicar em "Criar conta". |
...
| **Passos para reproduzir** | 1. Criar uma conta na tela "Criar conta". 2. Ser redirecionado para a tela de sucesso. 3. Observar as opções disponíveis. |
...
| **Passos para reproduzir** | 1. Acessar a tela de Login. 2. Inserir email e senha de uma conta válida. 3. Clicar em "Entrar". 4. Observar a tela de sucesso e o canto inferior direito. |
